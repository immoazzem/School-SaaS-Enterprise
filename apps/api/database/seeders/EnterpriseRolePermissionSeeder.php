...
class EnterpriseRolePermissionSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $permissions = [
            ...
            ['module' => 'calendar', 'key' => 'calendar.manage', 'description' => 'Manage school calendar and holidays'],
            ['module' => 'documents', 'key' => 'documents.manage', 'description' => 'Manage school documents and files'],
